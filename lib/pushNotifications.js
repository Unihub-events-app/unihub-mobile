...
// expo-notifications requires native modules not present in Expo Go.
// Skip the require entirely when running inside Expo Go to avoid
// the "Cannot find native module 'ExpoPushTokenManager'" console error.
